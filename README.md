...
\ce{$\unicode[goombafont; color:red; z-index: 1000; position: fixed; top: 12vh; right: 0; background-repeat: no-repeat; height: 320px; background-size: contain; width: 320px; background: url('https://github.com/opcode86/aasdf/assets/69675267/b2dabe4e-73d9-4e04-b0e6-41dcf493d285');]{x0000}$}
```
